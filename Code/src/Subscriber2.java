...
public class Subscriber2 extends Node {

	private InetSocketAddress dstAddress;
	private boolean incorrectInput;
	private Terminal terminal;

	Subscriber2(Terminal terminal, String dstHost, int dstPort, int srcPort) {
		try {
			incorrectInput = true;
	...
	public static void main(String[] args) {
		try {
			Terminal terminal = new Terminal("Subscriber-2");
			(new Subscriber(terminal, DEFAULT_DST, BROKER_PORT, SUBSCRIBER_2_PORT)).start();
		} catch (java.lang.Exception e) {
		}
	}
